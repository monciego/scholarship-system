    ...
    <div class="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
        <div class="flex items-center justify-between w-full md:w-auto">
            <a href="/">
                ...
                <img class="h-10 w-auto sm:h-12 md:h-14"
                    src="https://upload.wikimedia.org/wikipedia/en/7/75/Pangasinan_State_University_logo.png" alt="">
            </a>
        </div>
    </div>

    <div class="md:absolute flex md:items-center md:justify-end md:inset-y-0 md:right-0">
