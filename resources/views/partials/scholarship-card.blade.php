<div class="flex flex-col bg-white rounded-2xl shadow-xl">
    <div class="flex-1 relative pt-16 px-6 pb-8 md:px-8">
        <div class="absolute top-0 p-4 inline-block bg-indigo-600 rounded-xl shadow-lg transform -translate-y-1/2">
        ...
        <h3 class="text-xl font-medium text-gray-900">Academic Scholarship</h3>
        <p class="mt-4 mb-2 text-base text-gray-500">Varius facilisi mauris sed sit. Non sed et duis
            dui
            leo, vulputate id malesuada non. Cras aliquet purus dui laoreet...
        </p>
