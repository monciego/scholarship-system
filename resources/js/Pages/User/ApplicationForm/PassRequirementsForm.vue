...
const form = useForm({
    ...
    requirements: Array(scholarshipProps.requirements.split("|").length).fill(
        null
    ),
});
...
<template>
    ...
    <section class="max-w-7xl mx-auto pt-5 pb-8 px-4 sm:px-6 x">
        ...
        <form
            @submit.prevent="
                form.post(route('pass-requirements.store'), {
        ...
        >
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div
                    ...
                    v-for="(
                        requirement, index
                    ) in scholarship.requirements.split('|')"
                    :key="index"
                >
                    <label
                        :for="'requirement_' + index"
                        class="block text-sm font-medium leading-6 text-gray-900"
                        >{{ requirement }}</label
                    >
                    <div class="mt-2">
                        <input
                            ...
                            @input="onFileChange(index, $event)"
                            multiple="multiple"
                        ...
                        <InputError
                            class="mt-2"
                            :message="form.errors['requirements_' + index]"
                        />
                    </div>
                </div>
            </div>
