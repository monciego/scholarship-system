<script setup>
defineProps(["rejectedAcademicApplicant", "decodedRequirements"]);
import { ref } from "vue";
...
<template>
    <div
        v-if="
            rejectedAcademicApplicant.scholarship.scholarshipType ===
    ...
    >
        ...
        >
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    ...
                    >
                        {{ rejectedAcademicApplicant.scholarship.scholarshipName }}
                    </div>
                </div>
            </div>
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <div
                        class="block px-4 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    >
                        {{ rejectedAcademicApplicant.student_id }}
                    </div>
                </div>
            </div>
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <div
                        class="block px-4 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    >
                        {{ rejectedAcademicApplicant.campus }}
                    </div>
                </div>
            </div>
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <div
                        class="block px-4 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    >
                        {{ rejectedAcademicApplicant.degree }}
                    </div>
                </div>
            </div>
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <div
                        class="block px-4 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    >
                        {{ rejectedAcademicApplicant.average }}
                    </div>
                </div>
            </div>
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <div
                        class="block px-4 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    >
                        {{ rejectedAcademicApplicant.admission_test_score }}
                    </div>
                </div>
            </div>
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <div
                        class="block px-4 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    >
                        {{ rejectedAcademicApplicant.email }}
                    </div>
                </div>
            </div>
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <div
                        class="block px-4 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    >
                        {{ rejectedAcademicApplicant.first_name }}
                    </div>
                </div>
            </div>
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <div
                        class="block px-4 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    >
                        {{ rejectedAcademicApplicant.middle_name }}
                    </div>
                </div>
            </div>
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <div
                        class="block px-4 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    >
                        {{ rejectedAcademicApplicant.last_name }}
                    </div>
                </div>
            </div>
        </div>

        <div v-if="rejectedAcademicApplicant.remarks" class="mt-4">
            <span v-if="rejectedAcademicApplicant.approve === 1"> Approve</span>
            <span v-if="rejectedAcademicApplicant.reject === 1"> Reject</span>
            Remarks:
            ...
            <div class="sm:col-span-3">
                <div class="mt-2">
                    <div
                        class="block px-4 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    >
                        {{ rejectedAcademicApplicant.remarks }}
                    </div>
                </div>
            </div>
        </div>
        ...
        >
            <p>
                {{
                    rejectedAcademicApplicant.scholarship.requirements.split("|")[
                        fileIndex
                    ]
                }}:
            </p>
