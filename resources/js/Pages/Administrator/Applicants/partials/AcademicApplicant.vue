<script setup>
defineProps(["academicApplicant", "decodedRequirements"]);
import { ref } from "vue";
...
<template>
    <div
        v-if="
            academicApplicant.scholarship.scholarshipType ===
    ...
    >
        ...
        >
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    ...
                    >
                        {{ academicApplicant.scholarship.scholarshipName }}
                    </div>
                </div>
            </div>
            <div class="sm:col-span-3">
            ...
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <div
                        class="block px-4 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    >
                        {{ academicApplicant.admission_test_score }}
                    </div>
                </div>
            </div>
            <div class="sm:col-span-3">
            ...
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <div
                        class="block px-4 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    >
                        {{ academicApplicant.last_name }}
                    </div>
                </div>
            </div>
        </div>

        <div v-if="academicApplicant.remarks" class="mt-4">
            <span v-if="academicApplicant.approve === 1"> Approve</span>
            <span v-if="academicApplicant.reject === 1"> Reject</span>
            Remarks:
        ...
        >
            <p>
                {{
                    academicApplicant.scholarship.requirements.split("|")[
                        fileIndex
                    ]
                }}:
            </p>
