...
<template>
    <div
        v-if="$page.props.flash.successModalPrivate"
        class="relative z-10"
                ...
                >
                            ...
                            >
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-600">
                                        Thank you for filling out the form! Your
                                    ...
                                    <a
                                        @click="show = false"
                                        class="text-sm mt-2 text-indigo-700 underline"
                                        target="__blank"
                                        :href="
                                            $page.props.flash
                                                .successModalPrivate
                    ...
                    >
                        <a
                            @click="show = false"
                            target="__blank"
                            :href="$page.props.flash.successModalPrivate"
